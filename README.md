...
| Feature | Description |
|---------|-------------|
| **SQL Engine** | Built on **Apache DataFusion** for high-performance Rust-native execution |
...
| `infrastructure::adapters` | Infrastructure | `DataFusionConnector` — SQL engine support |
